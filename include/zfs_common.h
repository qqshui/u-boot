...
#else
#define grub_le_to_cpu16 cpu_to_le16
#define grub_be_to_cpu16 cpu_to_be16
#define grub_le_to_cpu32 cpu_to_le32
#define grub_be_to_cpu32 cpu_to_be32
#define grub_le_to_cpu64 cpu_to_le64
#define grub_be_to_cpu64 cpu_to_be64
#endif
...
//int zfs_ls(const char *dirname);
int zfs_ls(device_t dev, const char *path,
	   int (*hook) (const char *, const struct zfs_dirhook_info *));
//void zfs_free_node(struct ext2fs_node *node, struct ext2fs_node *currroot);
