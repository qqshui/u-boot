		     ...
		     grub_zfs_endian_t endian, char *buf, int size)
{
  ...
  if ((actual_cksum.zc_word[0] != zc.zc_word[0]) 
    ...
    {
      /*
      printf ("zfs", "checksum %d verification failed\n", checksum);
      printf ("zfs", "actual checksum %16llx %16llx %16llx %16llx\n",
      ...
      printf ("zfs", "expected checksum %16llx %16llx %16llx %16llx\n",
